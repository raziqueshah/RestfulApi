 ...
 */
export declare const createConference: (accessToken: JwtToken, options: CreateConferenceOptions) => Promise<Conference>;
/**
 ...
 */
export declare const invite: (accessToken: JwtToken, conferenceId: string, participants: Array<Participant>) => Promise<UserTokens>;
/**
