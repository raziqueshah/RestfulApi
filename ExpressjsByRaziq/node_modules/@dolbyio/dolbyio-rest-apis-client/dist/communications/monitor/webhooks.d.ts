 ...
 */
export declare const getEvents: (accessToken: JwtToken, options: GetWebhooksOptions) => Promise<GetWebHookResponse>;
/**
 ...
 */
export declare const getAllEvents: (accessToken: JwtToken, options: GetAllWebhooksOptions) => Promise<Array<WebHook>>;
